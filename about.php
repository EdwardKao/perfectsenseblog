			...
			<div class="welcome">
				<div class="welcome-top heading">
					...
					<div class="welcome-bottom">
						...
						<p>Thoughts from a 4th year BA Computer Science Major and Economics Minor.</p>
						<p>Past jobs include: Basketball Coach, Camp Counselor, Software Development Intern, Head Teacher Assistant 
						</p>
					</div>
				</div>
			</div>
			<div class="team">	
				<h3 class="team-heading">Meet Me</h3>
				<div class="team-grids">
					<div class="col-md-6 team-grid">
						<div class="team-grid1">
							<img src="images/me_pic_340x340.jpg" alt=" " class="img-responsive">
							<!--<div class="p-mask">
								<p></p>
								
							</div>-->
						</div>
						<h5>Edward Kao<span>Software Engineer</span></h5>
						<ul class="social">
							<li><a class="social-facebook" href="https://www.facebook.com/edward.kao.73">
								<i></i>
								<div class="tooltip"><span>Facebook</span></div>
								</a></li>
							<li><a class="social-twitter" href="https://twitter.com/CoachKao">
								<i></i>
								<div class="tooltip"><span>Twitter</span></div>
								</a></li>
							<li><a class="social-google" href="https://plus.google.com/113896702266798166376">
								<i></i>
